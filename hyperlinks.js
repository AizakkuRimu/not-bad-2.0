...
(function() {
  ...
  */
  ...
  /* NOTE: toolbar clicks are handled by uiwiring.js (Frieren panel).
     The overlays (#hlInsertOverlay, #hlAutoOverlay) are opened only
     programmatically via window._NB_openHlInsert / _NB_openHlAuto. */
