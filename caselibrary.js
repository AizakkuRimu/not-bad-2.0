...
(function () {
  ...
  function findClosingEnd(text) {
    ...
    /* Priority 3: "Thank you" as a standalone closing line (some cases end here) */
    /* Matches "Thank you" on its own line, optionally followed by up to 6 trailing lines */
    var thankYouRe  = /^Thank you[^\n]*(?:\n[^\n]*){0,6}/gim;
