...
(function () {
  ...
  function findClosingEnd(text) {
    ...
    /* Priority 2: "We would be pleased/glad …" only when the same line
       also contains "if" AND "assistance" — this avoids false matches on
       body sentences that happen to start with "We would be pleased to". */
