          ...
          var fixedCases = imp.cases.map(function(c) {
            return {
              ...
              cells: c.cells.map(function(cell, i) {
                ...
                /* Join soft-wrapped mid-sentence lines in the letter body —
                   fixes exports where lines were broken mid-sentence (\n
                   without punctuation). Real paragraph breaks (\n\n) are
                   preserved. Works for both formats. */
                return joinWrappedLines(cell);
              })
            };
          });
