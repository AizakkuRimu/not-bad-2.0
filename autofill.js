...
(function () {
  ...
  function buildCorpus() {
    ...
    /* Respect active tag filter if any */
    var activeTags = window._NB_activeTags; /* Set exposed by caselibrary */
    var cases = tl.cases;
    if (activeTags && activeTags.size > 0) {
      cases = cases.filter(function(c) { return activeTags.has(c.tag || ''); });
    }
